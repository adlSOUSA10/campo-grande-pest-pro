        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              >
                <MessageCircle className="w-5 h-5" style={{ color: "hsl(var(--whatsapp))" }} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-foreground/65">
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Descupinização</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Controle de Baratas</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Controle de Ratos</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Controle de Formigas</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Controle de Mosquitos</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Percevejos de cama</a></li>
              <li><a href="#servicos" className="hover:text-foreground transition-colors">Limpeza de Reservatórios d'água</a></li>
            </ul>
          </div>
        </div>
